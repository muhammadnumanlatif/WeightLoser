                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Center(child: FittedBox(child: Text('Lbs',
                        ...
                        Container(
                          ...
                          child: Center(child: FittedBox(child: Text('Kg',
                            style: TextStyle(fontWeight: FontWeight.w600),))),
                        ),
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('120 Lbs', style: TextStyle(
                          fontSize: height * 0.04,
                  ...
                  Text('Recommended Weight range is 82 lbg to - 108 lbg',
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => SelectYourTargetWeight(),),);
                    },
                    child: Container(
                      height: height * 0.06,
                      width: width * 0.6,
